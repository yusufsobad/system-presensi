...
abstract class metronic_template{
	...
	private static function _btn_modal_save($args=array(),$idx='0'){
		...
		?>
		<button id="btn_<?php print($idx) ;?>" data-sobad="<?php print($args['link']) ;?>" data-load="<?php print($args['load']) ;?>" data-type="<?php print($type) ;?>" type="submit" class="btn blue" data-index="<?php print($index) ;?>" data-modal="<?php print($modal) ;?>" <?php print($status) ;?>>Save</button>
