...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
			...
			$('#themes-themes').attr("href", 'themes/default/asset/css/layout/css/themes/' + color_ + ".css");
            //$('#style_color').attr("href", Layout.getLayoutCssPath() + 'themes/' + color_ + ".css");
            if (color == 'light2') {
                $('.page-logo img').attr('src', 'asset/img/logo-invert.png');
				//$('.page-logo img').attr('src', Layout.getLayoutImgPath() + 'logo-invert.png');
            } else {
				$('.page-logo img').attr('src', 'asset/img/logo.png');
